...
# from ml_dsa import ML_DSA  # <- REMOVE THIS LINE
...
# Function to return instances instead of directly initializing
def get_ml_dsa_instances():
    from ml_dsa import ML_DSA  # Import inside the function to avoid circular import
